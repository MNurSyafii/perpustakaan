...
<span class="font-medium">{{ \App\Models\Peminjaman::count() }}</span>
        ...
        <div class="col-md-6 col-lg-3 animate__animated animate__fadeInUp" style="animation-delay: 0.3s">
            <div class="stat-card bg-white shadow-sm">
                <div class="stat-icon">
                    <i class="fas fa-users text-purple" style="color: var(--purple-color)"></i>
                </div>
<span class="font-medium">{{ \App\Models\User::count() }}</span>
                <div class="stat-label">Total Anggota</div>
                <div class="mt-3">
                    <a href="{{ route('user.tampil') }}" class="btn btn-sm btn-outline-purple" style="color: var(--purple-color); border-color: var(--purple-color)">
                        <i class="fas fa-eye me-1"></i> Lihat Detail
                    </a>
                </div>
            </div>
    ...
    <div class="row g-4">
        ...
        <!-- Anggota Menu -->
        <div class="col-md-6 col-lg-3">
            <div class="custom-card shadow-sm h-100 animate__animated animate__fadeInUp" style="animation-delay: 0.6s">
                <div class="card-header-purple d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold">Anggota</h5>
                    <i class="fas fa-users fs-3 opacity-75"></i>
                </div>
                <div class="card-body p-4">
                    <p class="text-muted mb-4">Kelola anggota perpustakaan</p>
                    <div class="d-grid gap-2">
                        <a href="{{ route('user.tampil') }}" class="btn btn-purple text-white" style="background-color: var(--purple-color)">
                            <i class="fas fa-eye me-2"></i>
                            <span>Lihat Anggota</span>
                        </a>
                        <a href="{{ route('user.create') }}" class="btn btn-outline-purple" style="color: var(--purple-color); border-color: var(--purple-color)">
